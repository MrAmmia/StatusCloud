...
public class ActiveVideoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_active_video, container, false);
        activeVideoList = root.findViewById(R.id.activeVideoList);
        imageSaver = new ImageSaver(getContext());
        swipeRefreshLayout = root.findViewById(R.id.swipe_refresh);
        loadingDialog = new LoadingDialog(requireActivity());
        adapter = new ActiveRecyclerViewAdapter(getActivity(), getContext(), imageSaver,"video/*");
        GridLayoutManager gridLayoutManager = new GridLayoutManager(getContext(), 2, RecyclerView.VERTICAL, false);
        activeVideoList.setLayoutManager(gridLayoutManager);
        adapter.StatusText = false;
        activeVideoList.setAdapter(adapter);
        return root;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter.setOnItemClick(new RecyclerviewOnClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                viewModel.setPath(imageSaver.getActiveVideoPath());
                Navigation.findNavController(requireView()).navigate(R.id.action_navigation_active_to_activeVideoViewFragment);
            }
        });
    }
            ...
            public void run() {
                ...
                if (dirFile.length != 0) {
                    ...
                    for (File file1 : dirFile) {
                        if (file1.getName().endsWith("nomedia") || file1.getName().endsWith("jpg")) {
                            continue;
