...
public class SavedImageFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_saved_image, container, false);
        savedImageList = root.findViewById(R.id.savedImageList);
        imageSaver = new ImageSaver(getContext());
        swipeRefreshLayout = root.findViewById(R.id.swipe_refresh);
        loadingDialog = new LoadingDialog(requireActivity());
        adapter = new SavedRecyclerViewAdapter(getActivity(), getContext(), imageSaver,"image/*");
        GridLayoutManager gridLayoutManager = new GridLayoutManager(getContext(), 2, RecyclerView.VERTICAL, false);
        savedImageList.setLayoutManager(gridLayoutManager);
        adapter.StatusText = true;
        savedImageList.setAdapter(adapter);
        return root;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter.setOnItemClick(new RecyclerviewOnClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                Navigation.findNavController(requireView()).navigate(R.id.action_navigation_saved_to_SavedImagePagerFragment);
            }
        });
    }
